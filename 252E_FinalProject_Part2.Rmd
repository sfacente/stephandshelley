...
The number of visits per patient ranges from 0 to 44 in any given year, with a median of 0 - 2 visits across years. The figure below presents number of visits per patient in each year, truncated at 25 visits.
