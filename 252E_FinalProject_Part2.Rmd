...
Unfortunately, this simulation ran for >60 hours and ultimately crashed Stephanie's laptop (without saving :/). We'd love some help on how to optomize this. Notably we keep getting an error message about rescaling the L variables (even after we thought we rescaled them), so that might be one thing to look at.
...
```{r loading in results from binary analysis}
load("O.Rdata")
