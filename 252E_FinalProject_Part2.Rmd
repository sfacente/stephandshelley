...
#Commented out so that it doesn't try to run when knitting.
# B = 50
# estimates_data2 <- matrix(nrow = B, ncol = 3)
# colnames(estimates_data2) <- c("Gcomp", "IPTW",  "TMLE") 
# 
...
# #armadillo COMMENTING THIS OUT BECAUSE IT DOESN'T WORK RIGHT NOW - JUST REPASTED THE EXACT CODE FROM LAB 2###
...
#This needed to be (x, 4) here bc there are 4 variables,not 0,2
...
save(estimates_Obin, file = "estimates_0bin112319.Rdata")
```
