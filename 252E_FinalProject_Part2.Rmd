...
estimates_SimParameterCheck[b,] <- c(sum.results2.MSM.g$cmat[2,1],
                         sum.results2.MSM.iptw$cmat[2,1],
                         sum.results2.MSM.tmle$cmat[2,1])
print(b)
...
Bias.g <- mean(estimates_SimParameterCheck[,1]) - PsiF
Variance.g <- var(estimates_SimParameterCheck[,1])
MSE.g <- mean((estimates_SimParameterCheck[,1]- PsiF)^2)

Bias.iptw <- mean(estimates_SimParameterCheck[,2]) - PsiF
Variance.iptw <- var(estimates_SimParameterCheck[,2])
MSE.iptw <- mean((estimates_SimParameterCheck[,2]- PsiF)^2)

Bias.tmle <- mean(estimates_SimParameterCheck[,3]) - PsiF
Variance.tmle <- var(estimates_SimParameterCheck[,3])
MSE.tmle <- mean((estimates_SimParameterCheck[,3]- PsiF)^2)
