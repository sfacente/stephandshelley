...
TrueParameterRegression <-glm(EY_abar ~ sum_abar, family= binomial)
...
print(b)
 ...
 save(estimates_Sim, file ="estimates_Sim013020_95iterations.Rdata")

load("estimates_Sim013020_95iterations.Rdata")
estimates_Sim<- as.data.frame(estimates_Sim)
estimates_Sim <- estimates_Sim %>% filter(!is.na(estimates_Sim$Gcomp))
