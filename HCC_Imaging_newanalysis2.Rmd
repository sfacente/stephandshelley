...
results_sim0.gcomp <- ltmle(SimDataIntervene.0,
                     Anodes= c("A1", "A2", "A3", "A4"),
                     Lnodes = c("La1", "Lb1", "La2", "Lb2", "La3", "Lb3", "La4", "Lb4"),
                     Ynodes = c("Y2","Y3", "Y4", "Y5"),
                     abar = 0,
...
sum4tmle_SL <- summary(results4, "tmle")
sum4iptw_SL <- summary(results4, "iptw")
sum4gcomp_SL <- summary(results4.gcomp, "gcomp")
##only renamed above to make it clear they now use SL

sum4tmle_SL$effect.measures$ATE$estimate
sum4iptw_SL$effect.measures$ATE$estimate
sum4gcomp_SL$effect.measures$ATE$estimate
##ditto
