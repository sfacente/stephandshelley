...
| ----------------- | ----------------- | -------- | --------|
| Gender | Male | `r male` | `r round(malep, 1)`% |
...
* For $W$ we created a nominal categorical variable for the 16 possible different combinations of sex, gender, and SES that apply to our dataset. 
