...
#If visits are 0-1 make 0 and if 2+ visits make it 1
  ...
  O$A2 <- 0
  O$A2[O$HCVData$VISIT_COUNT_2016>1]<-1
  O$A3 <- 0
  ...
  O$Sex <- HCVData$Sex
  O$Race <- NA
  O$Race[!is.na(HCVData$Race) & !is.na(HCVData$Ethnicity)] <- 1
  O$Race[HCVData$Race == "White or Caucasian" & 
                                HCVData$Ethnicity == "Not Hispanic or Latino" ] <- 2
  O$Race[HCVData$Race == "Black or African American" & 
                                HCVData$Ethnicity == "Not Hispanic or Latino" ] <- 3
  O$Race[HCVData$Ethnicity == "Hispanic or Latino" ] <- 4
...
#save(estimates, file = "estimates_Obin112319.Rdata")
...
#This is checking for linearity based on whether visits occured more thanannually among our observed data
Plot4
```
