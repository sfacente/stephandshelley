...
Once someone develops the outcome [$Y(t) = 1$], we set their $A(t+1...K)$ and $L(t+1,...,K)$ to \textit{\textcolor{orange}{NA}} for the remainder of the analysis, and set $C(K) = 1$ for that subject. 
...
* __82.8%__ of participants had FIB-4 scores at the start of the study.
...
<!--* `r round(end, 1)`% of participants had a measured FIB-4 score rather than an imputed value at the end of the study.-->
* __95.5%__ of participants had a measured FIB-4 score rather than an imputed value at the end of the study.
...
\begin{align*}
\Psi^F(P_{U,X}) &= E(Y_{\bar{a}, C(K)=0}) = m(\bar{a} | \beta, V) \\
&= \beta_0 \ + \ \beta_1 \sum\limits_{t = 1}^Ka(t) + \beta_2V\\
\end{align*}
...
ggtitle("Expected Probability of HCC Dependant on Number of Visits in Simulated Data")  +
...
**Over the five years under study, patients are `r round(gcompbeta, 1)`% less likely to develop HCC each year that they had at least two primary care or hepatology visits, compared to patients who had one or fewer primary care of hepatology visits that year, adjusting for liver cirrhosis.**
