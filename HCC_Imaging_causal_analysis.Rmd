...
```{r}
HCVData1$PC_2015_VISIT_COUNT <- ifelse(is.na(HCVData1$PC_2015_VISIT_COUNT), 0, HCVData1$PC_2015_VISIT_COUNT)
HCVData1$PC_2016_VISIT_COUNT <- ifelse(is.na(HCVData1$PC_2016_VISIT_COUNT), 0, HCVData1$PC_2016_VISIT_COUNT)
HCVData1$PC_2017_VISIT_COUNT <- ifelse(is.na(HCVData1$PC_2017_VISIT_COUNT), 0, HCVData1$PC_2017_VISIT_COUNT)
HCVData1$PC_2018_VISIT_COUNT <- ifelse(is.na(HCVData1$PC_2018_VISIT_COUNT), 0, HCVData1$PC_2018_VISIT_COUNT)
HCVData1$PC_2019_VISIT_COUNT <- ifelse(is.na(HCVData1$PC_2019_VISIT_COUNT), 0, HCVData1$PC_2019_VISIT_COUNT)
HCVData1$HEP_2015_VISIT_COUNT <- ifelse(is.na(HCVData1$HEP_2015_VISIT_COUNT), 0, HCVData1$HEP_2015_VISIT_COUNT)
HCVData1$HEP_2016_VISIT_COUNT <- ifelse(is.na(HCVData1$HEP_2016_VISIT_COUNT), 0, HCVData1$HEP_2016_VISIT_COUNT)
HCVData1$HEP_2017_VISIT_COUNT <- ifelse(is.na(HCVData1$HEP_2017_VISIT_COUNT), 0, HCVData1$HEP_2017_VISIT_COUNT)
HCVData1$HEP_2018_VISIT_COUNT <- ifelse(is.na(HCVData1$HEP_2018_VISIT_COUNT), 0, HCVData1$HEP_2018_VISIT_COUNT)
HCVData1$HEP_2019_VISIT_COUNT <- ifelse(is.na(HCVData1$HEP_2019_VISIT_COUNT), 0, HCVData1$HEP_2019_VISIT_COUNT)
HCVData1$totalPC <- HCVData1$PC_2015_VISIT_COUNT + HCVData1$PC_2016_VISIT_COUNT + HCVData1$PC_2017_VISIT_COUNT + HCVData1$PC_2018_VISIT_COUNT + HCVData1$PC_2019_VISIT_COUNT
HCVData1$totalHep <- HCVData1$HEP_2015_VISIT_COUNT + HCVData1$HEP_2016_VISIT_COUNT + HCVData1$HEP_2017_VISIT_COUNT + HCVData1$HEP_2018_VISIT_COUNT + HCVData1$HEP_2019_VISIT_COUNT
HCVData1$totalPC <- ifelse(HCVData1$totalPC==0, "none", ifelse(HCVData1$totalPC>0 & HCVData1$totalPC<6, "low", ifelse(HCVData1$totalPC>5 & HCVData1$totalPC<11, "mid", "high"))) 
HCVData1$totalHep <- ifelse(HCVData1$totalHep==0, "none", ifelse(HCVData1$totalHep>0 & HCVData1$totalHep<6, "low", ifelse(HCVData1$totalHep>5 & HCVData1$totalHep<11, "mid", "high"))) 
table(HCVData1$race.ethnicity, HCVData1$totalPC)
table(HCVData1$race.ethnicity, HCVData1$totalHep)
```
...
func$plot + geom_vline(xintercept = 0, linetype="dashed", color = "red", size = 1)
```
