...
Yearsof2VwI_ptest <- as.vector(c(Yearsof2VwI_1, Yearsof2VwI_2, Yearsof2VwI_3, Yearsof2VwI_4, Yearsof2VwI_5))
Yearsof2VwI_ptest <- mean(Yearsof2VwI_ptest); Yearsof2VwI_ptest

#NNT
NNTdenom <- Yearsof2VwI_ptest/100
NNT <- round(1/(Yearsof2VwI_ptest/100), 0); NNT
```
